...
const ReviewsPopup = ({review, setOpenReviewPopup, ride, getReviews}) => {
  ...
  return (
    <div className='popup'>
      ...
      {openAddReviewPopup && <AddReviewPopup ride={ride} getReviews={getReviews} review={review} setOpenAddReviewPopup={setOpenAddReviewPopup}/>}
